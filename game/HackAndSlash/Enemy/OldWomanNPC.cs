...
namespace HackAndSlash
{
    class OldWomanNPC : IEnemy
    {
        ...
        public OldWomanNPC(Vector2 startPosition, GraphicsDevice graphics, SpriteBatch spriteBatch, Game1 game) 
        {
            ...
            oldManSprite = SpriteFactory.Instance.GetOldWoman();
