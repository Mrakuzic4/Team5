...
{
    class ItemEnemyCollisionHandler
    {
        public void HandleCollision(IEnemy enemy, IPlayer player, CollisionType collisionType) //Possibly need ICollision?? See the 2D collision slide.
        {
