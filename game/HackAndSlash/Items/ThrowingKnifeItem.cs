...
namespace HackAndSlash
{
    public class ThrowingKnifeItem : IItem
    {
        ...
        public ThrowingKnifeItem(Vector2 startPosition, SpriteBatch gameSpriteBatch, Game1 game)
        {
            ...
            toolBarPosition = new Vector2(2 * GlobalSettings.BASE_SCALAR, GlobalSettings.TOOLBAR_OFFSET);
        ...
        public void Draw()
        {
            switch (itemState.state)
            {
                ...
                case ThrowingKnifeStateMachine.ItemStates.Useable:
                    ...
                    throwingKnifeSprite.DrawOnBar(spriteBatch, position, Color.White);
        ...
        public bool FogBreaker()
        {
            return (itemState.state == ThrowingKnifeStateMachine.ItemStates.Useable
                || itemState.state == ThrowingKnifeStateMachine.ItemStates.BeingUsed);
        }
